  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Light vignette/gradient overlay to ensure text contrast while keeping image fully visible */}
      ...
      <div className="relative z-20 w-[90%] mx-auto text-left rtl:text-right space-y-8">
        <div className="max-w-lg md:max-w-xl lg:max-w-2xl space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              {isArabic ? (
                "من صحراء وادي رم الأردنية الشبيهة بسطح المريخ، نشيد طموحات المعرفة الفضائية وجيل المبتكرين العرب من خلال أبحاث المحاكاة الأنالوج وهندسة بدلات الفضاء وتدريب الطالبات."
              ) : (
                "From Jordan’s Martian-like Wadi Rum desert, we build space sciences and inspire the Arab future through custom analog simulation suites, aerospace research, and youth STEM missions."
              )}
            </motion.p>
          </div>
